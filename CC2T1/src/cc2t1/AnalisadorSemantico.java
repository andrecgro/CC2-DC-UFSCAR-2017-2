...
public class AnalisadorSemantico extends LABaseVisitor<Void> {  
    ...
    public String getTipo(LAParser.Parcela_unarioContext ctx) {
    ...
    public String getTipo(LAParser.Parcela_nao_unarioContext ctx){
        //'&' IDENT outros_ident dimensao
        if(ctx.IDENT() != null){
            /*if(ctx.outros_ident().identificador() != null){
                String tipo = pilhaDeTabelas.getTipo(ctx.IDENT().getText()+"."+ctx.outros_ident().identificador().IDENT().getText());
    ...
    public String getTipo(LAParser.ParcelaContext ctx){
    ...
    public String getTipo(LAParser.Outras_parcelasContext ctx){
    ...
    public String getTipo(LAParser.FatorContext ctx) {
        String tipoParcela = getTipo(ctx.parcela());
        //parcela outras_parcelas
        if(ctx.outras_parcelas().parcela() != null){
            String tipoOutros = getTipo(ctx.outras_parcelas());
    ...
    public String getTipo(LAParser.Outros_fatoresContext ctx){
    ...
    public String getTipo(LAParser.TermoContext ctx){
        String tipoFator = getTipo(ctx.fator());
    ...
    public String getTipo(LAParser.Outros_termosContext ctx){
    ...
    public String getTipo(LAParser.Exp_aritmeticaContext ctx){
        String tipoTermo = getTipo(ctx.termo());
        //termo outros_termos
        if(ctx.outros_termos().termo() != null){
            String tipoOutros = getTipo(ctx.outros_termos());
    ...
    public String getTipo(LAParser.Exp_relacionalContext ctx){
    ...
    public String getTipo(LAParser.Parcela_logicaContext ctx){
    ...
    public String getTipo(LAParser.Fator_logicoContext ctx){
        //op_nao parcela_logica
        return getTipo(ctx.parcela_logica());
    }
    
    public String getTipo(LAParser.Outros_fatores_logicosContext ctx){
    ...
    public String getTipo(LAParser.Termo_logicoContext ctx){
        String tipoFator_logico = getTipo(ctx.fator_logico());
    ...
    public String getTipo(LAParser.Outros_termos_logicosContext ctx){
    ...
    public String getTipo(LAParser.ExpressaoContext ctx){
        String tipoTermo_logico = getTipo(ctx.termo_logico());
    ...
    public Void visitDeclaracao_local(LAParser.Declaracao_localContext ctx) {
        ...
        if(ctx.variavel() != null){
            ...
            LAParser.Mais_varContext auxCtx = ctx.variavel().mais_var();
            ...
            if(ctx.variavel().tipo().registro() != null){
                while(nomeBase.peek() != null){
                    ...
                    LAParser.VariavelContext auxCtx2 = ctx.variavel().tipo().registro().variavel();
                    LAParser.Mais_variaveisContext auxCtx5 = ctx.variavel().tipo().registro().mais_variaveis();
                    ...
                    while(auxCtx5 != null){
                        ...
                        if(auxCtx2.tipo().tipo_estendido() != null){
                            LAParser.Ponteiros_opcionaisContext auxCtx3 = auxCtx2.tipo().tipo_estendido().ponteiros_opcionais().ponteiros_opcionais();
                            while(auxCtx3 != null){    
                                tipoVar += "^";
                            ...
                            //trata mais_vars
                            LAParser.Mais_varContext auxCtx4 = auxCtx2.mais_var();
            ...
            //caso: IDENT dimensao mais_var ':' tipo -> tipo_estendido -> ponteiros_opcionais tipo_basico_ident
                ...
                String tipoVar = "";
                LAParser.Ponteiros_opcionaisContext auxCtx2 = ctx.variavel().tipo().tipo_estendido().ponteiros_opcionais().ponteiros_opcionais();
                while(auxCtx2 != null){    
                    tipoVar += "^";
            ...
            if(pilhaDeTabelas.topo().existeSimbolo(nomeVar)){
                ...
                //caso: 'tipo' IDENT ':' tipo;
                    ...
                    if(ctx.tipo().registro() != null){
                        ...
                        LAParser.VariavelContext auxCtx = ctx.tipo().registro().variavel();
                        LAParser.Mais_variaveisContext auxCtx2 = ctx.tipo().registro().mais_variaveis();
                        
                        //faz para cada variavel
                        while(auxCtx2 != null) {
                            //pega o tipo
                            String tipoVar = "";
                            LAParser.Ponteiros_opcionaisContext auxCtx3 = auxCtx.tipo().tipo_estendido().ponteiros_opcionais().ponteiros_opcionais();
                            while(auxCtx3 != null){    
                                tipoVar += "^";
                                auxCtx3 = auxCtx3.ponteiros_opcionais();
                            }
                            ...
                            //verifica mais_vars
                            LAParser.Mais_varContext auxCtx4 = auxCtx.mais_var();
                    ...
                    //caso: tipo_estendido
                        ...
                        String tipoTipo = "";
                        LAParser.Ponteiros_opcionaisContext auxCtx = ctx.tipo().tipo_estendido().ponteiros_opcionais().ponteiros_opcionais();
                        while(auxCtx != null){    
                            tipoTipo += "^";
    ...
    @Override public Void visitTipo_basico_ident(LAParser.Tipo_basico_identContext ctx) { 
        if(ctx.IDENT() != null){
    ...
    @Override public Void visitParcela(LAParser.ParcelaContext ctx) { 
        String nomeVar;
    ...
    @Override public Void visitDeclaracao_global(LAParser.Declaracao_globalContext ctx) {
        //apenas um IDENT
        String nomeVar = ctx.IDENT().getText();
        String tipoVar;
        ...
        if(pilhaDeTabelas.topo().existeSimbolo(nomeVar)){
            ...
            if(ctx.parametros_opcional().parametro() != null){
                ...
                LAParser.ParametroContext auxCtx = ctx.parametros_opcional().parametro();
    ...
    @Override public Void visitCmd(LAParser.CmdContext ctx) { 
        //caso leia
        if(ctx.identificador() != null){
            ...
            LAParser.Mais_identContext auxCtx = ctx.mais_ident();
    ...
    @Override public Void visitParametro(LAParser.ParametroContext ctx) {
        ...
        LAParser.Mais_parametrosContext auxCtx = ctx.mais_parametros();
    ...
    public Void visitParcela_unario(LAParser.Parcela_unarioContext ctx){
        ...
        if(ctx.chamada_partes() != null){
            ...
            if(ctx.chamada_partes().expressao() != null){
                ...
                LAParser.Mais_expressaoContext auxCtx = ctx.chamada_partes().mais_expressao();
